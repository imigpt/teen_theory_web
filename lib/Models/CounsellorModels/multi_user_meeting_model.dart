...
//
//     final filterMultiMeetingByCreatorModel = filterMultiMeetingByCreatorModelFromJson(jsonString);

import 'dart:convert';

FilterMultiMeetingByCreatorModel filterMultiMeetingByCreatorModelFromJson(String str) => FilterMultiMeetingByCreatorModel.fromJson(json.decode(str));

String filterMultiMeetingByCreatorModelToJson(FilterMultiMeetingByCreatorModel data) => json.encode(data.toJson());

class FilterMultiMeetingByCreatorModel {
    bool? success;
    String? message;
    List<Datum>? data;

    FilterMultiMeetingByCreatorModel({
        this.success,
        this.message,
        this.data,
    });

    factory FilterMultiMeetingByCreatorModel.fromJson(Map<String, dynamic> json) => FilterMultiMeetingByCreatorModel(
