...
//
//     final allParentModel = allParentModelFromJson(jsonString);

import 'dart:convert';

AllParentModel allParentModelFromJson(String str) => AllParentModel.fromJson(json.decode(str));

String allParentModelToJson(AllParentModel data) => json.encode(data.toJson());

class AllParentModel {
    bool? success;
    String? message;
    List<Datum>? data;
    ...
    factory AllParentModel.fromJson(Map<String, dynamic> json) => AllParentModel(
...
class Datum {
    ...
    factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        child: json["child"] == null ? null : Datum.fromJson(json["child"]),
