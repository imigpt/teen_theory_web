...
//
//     final allMentorModel = allMentorModelFromJson(jsonString);

import 'dart:convert';

AllMentorModel allMentorModelFromJson(String str) => AllMentorModel.fromJson(json.decode(str));

String allMentorModelToJson(AllMentorModel data) => json.encode(data.toJson());
...
class AllMentorModel {
    ...
    factory AllMentorModel.fromJson(Map<String, dynamic> json) => AllMentorModel(
