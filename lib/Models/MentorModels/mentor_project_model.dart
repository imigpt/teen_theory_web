...
//
//     final mentorProjectModel = mentorProjectModelFromJson(jsonString);

import 'dart:convert';

MentorProjectModel mentorProjectModelFromJson(String str) => MentorProjectModel.fromJson(json.decode(str));

String mentorProjectModelToJson(MentorProjectModel data) => json.encode(data.toJson());

class MentorProjectModel {
    bool? success;
    String? message;
    List<Datum>? data;
    ...
    factory MentorProjectModel.fromJson(Map<String, dynamic> json) => MentorProjectModel(
