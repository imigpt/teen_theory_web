      ...
      builder: (context, pvd, child) {
        return Scaffold(
          ...
          appBar: AppBar(
            title: Text(
              "Upload Resources",
              style: textStyle(fontFamily: AppFonts.interBold, fontSize: 20),
            ),
          ),
          body: SingleChildScrollView(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    "Add helpful materials for your assign project",
                    style: textStyle(
                      fontSize: 14,
                  ...
                  DropdownButtonFormField(
                    value: "All Fundamental Projects - Sana Watson",
                    ...
                    items: [
                      DropdownMenuItem(
                        value: "All Fundamental Projects - Sana Watson",
                        child: Text("All Fundamental Projects - Sana Watson"),
                      ),
                      DropdownMenuItem(
                        value: "AI ML Projects - Sana Watson",
                        child: Text("AI ML Projects - Sana Watson"),
                      ),
                    ],
                    onChanged: (value) {},
                  ),
                  ...
                  GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isSelected =
                          pvd.selectedResourceType == type['value'];
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintStyle: textStyle(color: Colors.grey),
                      hintText:
                          "Brief description of how this resource helps...",
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(8),
                      ),
                    ),
                  ...
                  // Enable Versioning
                  CheckboxListTile(
                    value: pvd.enableResourceVersioning,
                    onChanged: (value) {
                      pvd.setEnableResourceVersioning = value ?? false;
                    },
                    title: Text(
                      "Enable Versioning",
                      style: textStyle(
                    ...
                    subtitle: Text(
                      "Keep history of updates to this resource",
                      style: textStyle(
                        fontSize: 12,
                        color: Colors.grey.shade600,
                      ),
                  ...
                  Text("Who can access this resources?"),
                  hSpace(height: 12),
                  ListView.builder(
                    itemCount: 2,
                    shrinkWrap: true,
                      ...
                      return Padding(
                        ...
                        child: Container(
                          ...
                          child: ListTile(
                            ...
                            title: Text("Eassy Structure Template"),
                            subtitle: Text("(Template * Used 247 times)"),
                          ),
                        ),
                      );
                    },
                  ...
                  ListTile(
                    ...
                    subtitle: Text("Previously added resources"),
                  ),
                  hSpace(height: 24),
                  ListView.builder(
                    shrinkWrap: true,
                      ...
                      return Padding(
                        ...
                        child: Container(
                          ...
                          child: ListTile(
                            ...
                            title: Text("Eassy Structure Template"),
                            subtitle: Text("Previously uploaded Resources"),
